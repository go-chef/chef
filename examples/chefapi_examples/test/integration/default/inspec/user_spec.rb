...
describe command('/go/src/chefapi_test/bin/user') do
  ...
  its('stdout') { should match(%r{^Add usr1 \{Uri:https://localhost/users/usr1 ChefKey:\{Name:default PublicKey:-----BEGIN}) }
  its('stdout') { should match(%r{^Add usr2 \{Uri:https://localhost/users/usr2 ChefKey:\{Name:default PublicKey:-----BEGIN}) }
  its('stdout') { should match(%r{^Add usr3 \{Uri:https://localhost/users/usr3 ChefKey:\{Name: PublicKey: ExpirationDate: Uri: PrivateKey:\}\}}) }
  ...
  its('stdout') { should match(%r{^Update usr1 partial update \{Uri:https://localhost/users/usr1 ChefKey:\{}) }
  ...
  its('stdout') { should match(%r{^Update usr1 full update \{Uri:https://localhost/users/usr1 ChefKey:\{Name: PublicKey: ExpirationDate: Uri: PrivateKey:\}}) }
  ...
  its('stdout') { should match(%r{^Update usr1 rename \{Uri:https://localhost/users/usr1new ChefKey:\{.*\}}) }
  ...
  its('stdout') { should match(%r{^Delete usr1 DELETE https://localhost/users/usr1: 404}) }
