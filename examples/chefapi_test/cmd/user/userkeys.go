...
func main() {
	...
	// Add a key to a user
<<<<<<< HEAD:examples/chefapi_examples/files/default/go/src/chefapi_test/cmd/user/userkeys.go
...
=======
	keyadd := chef.UserKey{
		KeyName:        "newkey",
		PublicKey:      "-----BEGIN PUBLIC KEY-----\nMIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAoYyN0AIhUh7Fw1+gQtR+ \\n1wIDAQAB \n-----END PUBLIC KEY-----\n\n",
>>>>>>> 14746d2... Moving folders around so structure is more readable:examples/chefapi_test/cmd/user/userkeys.go
