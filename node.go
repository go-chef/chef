...
func (e *NodeService) List() (data map[string]string, err error) {
	err = e.client.magicRequestDecoder("GET", "nodes", UseOrg, nil, &data)
	return
}
...
func (e *NodeService) Get(name string) (node Node, err error) {
	...
	err = e.client.magicRequestDecoder("GET", url, UseOrg, nil, &node)
	return
}
...
func (e *NodeService) Head(name string) (err error) {
	url := fmt.Sprintf("nodes/%s", name)
	err = e.client.magicRequestDecoder("HEAD", url, UseOrg, nil, nil)
	return
}
...
func (e *NodeService) Post(node Node) (data *NodeResult, err error) {
	...
	err = e.client.magicRequestDecoder("POST", "nodes", UseOrg, body, &data)
	return
}
...
func (e *NodeService) Put(n Node) (node Node, err error) {
	...
	err = e.client.magicRequestDecoder("PUT", url, UseOrg, body, &node)
	return
}
...
func (e *NodeService) Delete(name string) (err error) {
	err = e.client.magicRequestDecoder("DELETE", "nodes/"+name, UseOrg, nil, nil)
	return
}
