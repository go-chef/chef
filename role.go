...
func (e *RoleService) List() (data *RoleListResult, err error) {
	err = e.client.magicRequestDecoder("GET", "roles", false, nil, &data)
	return
}
...
func (e *RoleService) Create(role *Role) (data *RoleCreateResult, err error) {
	...
	err = e.client.magicRequestDecoder("POST", "roles", false, body, &data)
...
func (e *RoleService) Delete(name string) (err error) {
	...
	err = e.client.magicRequestDecoder("DELETE", path, false, nil, nil)
	return
}
